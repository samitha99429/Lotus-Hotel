...
const AccomadationCard = ({ imageLink, title, paragraph }) => {
  return (
    ...
    <div className="md:container md:mx-auto  px-4 py-6 md:mt-6">
        ...
        <div className="flex flex-cols-1 md:flex-cols-2 lg:flex-cols-3 gap-4  ">
          <article className=" shadow-lg bg-white rounded-lg">
            <div className='relative'>
              <Image src={imageLink} alt="My Image" width={0} height={0} layout='responsive' className={`${styless.imageresponsive} transform hover:scale-90 transition duration-500 ease-out object-cover w-full h-full
`} />
